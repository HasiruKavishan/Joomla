...
<head>
	...
	<?php
		...
		$doc->addStyleSheet('templates/'.$this->template.'/css/ext.asmenu.css');
    ...
    <div class="wrapper">
        <div id="navigation-row">
            ...
            <?php if ($this->countModules('as-position-1')): ?>
                <jdoc:include type="modules" name="as-position-1" style="html5nosize" />
            <?php endif; ?>
        </div>
        
		<?php if ($this->countModules('as-position-5')): ?>
        <div id="slider-row">
            <jdoc:include type="modules" name="as-position-5" style="html5nosize" />
        </div>
        <?php endif; ?>        
